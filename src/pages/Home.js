...
import networkpng from '../network.png'
    ...
    return (
        <div className='bg-[#1A1A1A] h-screen w-full overflow-auto'>
            ...
            <div className='flex items-center justify-between w-full p-4 '>
                <div className='text-xl flex flex-col items-center justify-center rounded-md bg-red-600 w-80 h-44'>
                    <div className='py-2 '>
                        <img src={networkpng}  className='w-16 h-16'/>
                    </div>
                    <div className='text-lg font-semibold'>Network</div>
                    <div>shielded-expedition.88f17d1d14</div>
                </div>
                <div className='text-xl flex flex-col  items-center justify-center rounded-md bg-blue-600 w-80 h-44'>
                    <div className='py-2 '>
                        <img src={height}  className='w-16 h-16'/>
                    </div>
                    <div className='text-lg font-semibold'>Latest Block Height</div>
                    <div>{latestBlock !== 'undefined' ? latestBlock["height"] : ""}</div>
                </div>
                <div className='text-xl flex flex-col  items-center justify-center rounded-md bg-green-600 w-80 h-44'>
                    <div className='py-2 '>
                        <img src={time}  className='w-16 h-16'/>
                    </div>
                    <div className='text-lg font-semibold'>Latest Block Time</div>
                    <div className='text-lg'>{latestBlock !== 'undefined' ? latestBlock["time"] : ""}</div>
                </div>
                <div className='text-xl flex flex-col  items-center justify-center rounded-md bg-yellow-600 w-80 h-44'>
                    <div className='py-2 '>
                        <img src={user}  className='w-16 h-16'/>
                    </div>
                    <div className='text-lg font-semibold'>Total Validators</div>
                    <div>{validatorData !== 'undefined' ? validatorData["total"] : ""}</div>
                </div>
            </div>
            <div className='w-full flex items-start justify-between p-4 space-x-6'>
                <div className='w-1/2 bg-black text-white p-6 rounded-md overflow-x-auto'>
                    <div>
        ...
        // <div className="flex-1 flex flex-col space-y-2 sm:space-y-4 text-white items-center justify-start bg-[#1A1A1A]">
